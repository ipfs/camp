...
| 5 | [IPID - Master key security and user-experience 📦](./05-ipid-master-key-ux.md) | **[@satazor](https://github.com/satazor)** | [IDM](https://github.com/ipfs-shipyard/pm-idm) (Identity Manager) aims to support several [DIDs](https://w3c-ccg.github.io/did-spec/) methods and [IPID](https://did-ipid.github.io/ipid-did-method) was chosen as the first DID method to be integrated. |
...
| 44 | [Decentralized Data Processing](./44-decentralized-data-processing.md) | **[@alari](https://github.com/alari)** | How could we process large amounts of data in permissionless networks? Use cases, verifiable state transitions, aggregations and bulk updates, etc. |
